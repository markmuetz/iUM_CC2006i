...
computers = {
    'zerogravitas': {
        'dirs': {
            'um_output': '/home/markmuetz/um_output/um10.6_runs/10day/',
            'output': '/home/markmuetz/Dropbox/omni_output/iUM_CC2006i/output',
            'output_cloud_stats': '/home/markmuetz/Dropbox/omni_output/iUM_CC2006i/output_cloud_stats',
        }
    },
    'Z580': {
        'dirs': {
...
expts = ['no_wind', 'weak_shear', 'strong_shear']
comp = computers['zerogravitas']
for expt in expts:
    comp['dirs']['work_' + expt] = '/home/markmuetz/omni_output/iUM_CC2006i/work_{}'.format(expt)
    comp['dirs']['results_' + expt] = '/home/markmuetz/omni_output/iUM_CC2006i/results_{}'.format(expt)
...
for expt in expts:
    ...
    nodes['count_clouds_plots_w1_qcl0p001_' + expt] = {
        ...
        'process_kwargs': {'w_thresh': 1, 'qcl_thresh': 0.001, 'start_index': 360, 'end_index': 720},
    }
